...
| `pnpm test:e2e`               | Playwright E2E (see [docs/e2e.md](docs/e2e.md); CI job in `.github/workflows/ci.yml`) |
...
| `pnpm local:dynamodb`         | DynamoDB Local on host `:7422`                                                        |
| `pnpm local:agent-web`        | Agent-pane Next.js UI on `:7423`                                                      |
