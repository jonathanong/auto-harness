...
- Do not lower the 99% project-function or patch coverage targets to land incomplete code. The aggregate **branch** floor is 98% until Vitest 5 restores 99%.
