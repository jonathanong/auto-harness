  ...
  test: {
    ...
    coverage: {
      ...
      include: [
        ...
        "modules/ui/src/components/{tooltip,dialog,dropdown-menu,confirm-button,toast,cursor-pagination,paginated-sessions}.tsx",
      ...
      thresholds: process.env.VITEST_SKIP_COVERAGE_THRESHOLDS
        ...
        : {
            ...
            "modules/ui/src/{lib/utils.ts,components/{tooltip,dialog,dropdown-menu,confirm-button,toast,cursor-pagination,paginated-sessions}.tsx}":
              { 100: true },
