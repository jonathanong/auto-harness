  ...
  test: {
    ...
    coverage: {
      ...
      include: [
        ...
        "services/web/src/components/{repo-create-form,edit-repo-form,provider-create-form,edit-provider-form,command-create-form,edit-command-form,schedule-create-form,schedule-edit-form,schedule-trigger-button,create-session-form,session-routing-fields,session-target-select,add-host-form,attach-local-repo-form,attach-provider-account-to-host-form,host-provider-account-command-form,host-repo-settings-form,provider-account-cooldown-form,add-provider-account-form,remove-provider-account-button,remove-provider-account-from-host-button,host-repositories-section,control-shell,host-filters,edit-worktree-form}.tsx",
      ],
      exclude: [
        "**/*.test.{ts,tsx}",
        "**/*-test-helpers.ts",
