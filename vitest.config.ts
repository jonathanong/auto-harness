  ...
  test: {
    ...
    coverage: {
      ...
      include: [
        ...
        "services/web/src/components/{add-provider-account-form,host-add-repo-form,host-repositories-section,remove-provider-account-button,remove-provider-account-from-host-button}.tsx",
