  ...
  test: {
    ...
    coverage: {
      ...
      include: [
        ...
        "modules/ui/src/components/{detail-header,provider-account-health,session-execution-summary,session-route-summary,session-timeout-progress,sessions-table,tabs}.tsx",
