...
describe("constants", () => {
  it("exports stable product constants", () => {
    ...
    expect(DEFAULT_MAX_CONCURRENT_SESSIONS).toBe(1);
    expect(MAX_CONCURRENT_SESSIONS_LIMIT).toBe(64);
    expect(DEFAULT_MAX_CONCURRENT_ASSIGNMENTS).toBe(64);
    expect(MAX_CONCURRENT_ASSIGNMENTS_LIMIT).toBe(256);
