...
describe("constants", () => {
  it("exports stable product constants", () => {
    ...
    expect(COMMAND_START_AUTHORIZATION_PROTOCOL_VERSION).toBe(4);
    expect(DEFERRED_TERMINAL_RESULT_PROTOCOL_VERSION).toBe(6);
    expect(TERMINAL_HOOK_HANDOFF_EXPIRY_PROTOCOL_VERSION).toBe(7);
