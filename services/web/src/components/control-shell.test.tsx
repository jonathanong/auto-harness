...
describe("ControlShell", () => {
  it("renders its control-plane chrome, children, and active nested route", () => {
    ...
    expect(field<HTMLAnchorElement>(document, "nav-workspace-pools").getAttribute("href")).toBe(
      "/workspace-pools",
    );
    ...
    expect(field<HTMLAnchorElement>(document, "nav-session-log-settings").getAttribute("href")).toBe(
