...
export function ScheduleEditForm({
  ...
  const targetValue = schedule.providerAccountId
    ? `account:${schedule.providerAccountId}`
    : `command:${schedule.commandId ?? ""}`;
  ...
  return (
    ...
    >
      ...
      <div className="space-y-1">
        <Label htmlFor="target" tip="Provider account or standalone command">
          Target
        </Label>
        <SessionTargetSelect
          targets={targets}
      ...
      <WithTooltip tip="Save schedule changes">
