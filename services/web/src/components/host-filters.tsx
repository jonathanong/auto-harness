...
import { hostListHref } from "../lib/url-state.ts";
...
export function HostFilters() {
  ...
  return (
    <div className={`flex items-end gap-3 ${pending ? "opacity-70" : ""}`} data-pw="host-filters">
