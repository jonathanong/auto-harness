      ...
      {!editing ? (
        <>
          <div className="flex flex-wrap items-center justify-between gap-2">
            ...
            <div className="flex gap-2">
              <WithTooltip tip="Edit path and labels for this worktree">
                <Button
                  type="button"
                  variant="outline"
                  size="sm"
        ...
        >
          <div className="space-y-1">
            <Label tip="Absolute filesystem path for this worktree on this host">
              path (absolute)
            </Label>
            <Input value={path} onChange={(e) => setPath(e.target.value)} required />
          </div>
          <div className="space-y-1">
            <Label tip="Comma-separated labels used when matching sessions to worktrees">
