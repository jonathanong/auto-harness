...
| `form-host-setup-script`, `host-setup-script`, `host-setup-script-submit`, `host-setup-script-ok`, `host-setup-script-error`, `form-host-config-json`, `host-config-json`, `host-config-json-validation`, `host-config-submit`, `host-config-ok`, `host-config-error`, `host-config-conflict`                                                                                                                                                                                                                                                                                                                                                                    | Host detail's Advanced tab — structured host setup plus syntax-highlighted, schema-validated raw inventory JSON; `host-config-conflict` distinguishes a stale full-document save                                                                                                                                                        |
...
| `page-provider-detail`, `page-provider-detail-not-found`, `provider-detail-id`, `provider-accounts-tab`, `provider-commands-tab`, `provider-settings`, `provider-account-row-*`, `provider-account-remove-*` (+ `-confirm`/`-confirm-submit`), `provider-command-row-*`, `provider-command-link-*`, `form-provider-default-command`, `provider-default-command-select`, `provider-default-command-submit`, `edit-provider-open`, `edit-provider-dialog`, `form-edit-provider`, `edit-provider-name`, `edit-provider-submit`, `edit-provider-error`, `delete-provider-open`, `delete-provider-confirm`, `delete-provider-confirm-submit`, `delete-provider-error` | Provider detail (`/providers/[id]`) — Accounts / Commands / Settings tabs                                                                                                                                                                                                                                                               |
...
| `e2e/control/host-advanced.spec.ts`           | edits host setup and validates the raw inventory editor                                      | Structured setup control, syntax/schema diagnostics, save gating, persistence, and conflict recovery                                              |
...
|                                      | settings page has drain control, host setup, and raw inventory JSON  | `/settings`: drain control, structured host setup, and validated JSON editor   |
