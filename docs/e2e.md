...
| `form-create-session`, `create-session-repository-id`, `create-session-target`, `create-session-prompt`, `create-session-timeout`, `create-session-ref`, `create-session-submit`, `create-session-error`                                                                                                                                                                                                                                                                                                                                                                                                                                 | Create session form — `create-session-target` is a `SessionTargetSelect` (Providers / Commands, including providerless pure CLI, sourced from `GET /api/v1/session-targets`); ordered fallbacks and queue TTL controls are rendered alongside it |
