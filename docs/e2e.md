...
| `page-hosts`, `hosts-heading`, `host-filters`, `host-filter-online`, `form-add-host`, `add-host-id`, `add-host-submit`, `add-host-ok`, `add-host-error`, `host-row-*`, `host-online-*`, `host-connected-at-*`, `host-daemon-started-at-*`, `host-restart-count-*`, `host-last-restart-*`, `host-drain-*`, `host-worktrees-*`, `host-worktree-link-*`                                                                                                                                                                                                                                                                                     | Hosts; connection badges say Online/Offline, connection and daemon times are semantic, detected process restarts are local observability, and each host expands to its worktree status/details                                                                                                                                   |
