...
| `page-session-detail`, `session-detail`, `session-detail-id`, `session-detail-copy-id`, `session-detail-copy-status`, `session-detail-status`, `session-detail-timeout`, `session-timeout-progress`, `session-timeout-remaining`, `breadcrumbs`, `page-session-detail-not-found`                                                                                                                                                                                                                                                                                                                                                         | Session detail (`/sessions/[id]`), including accessible Session ID clipboard feedback and running timeout progress                                                                                                                                                           |
...
| `page-session-detail`, `session-detail`, `session-detail-id`, `session-detail-status`, `session-detail-timeout`, `session-timeout-progress`, `session-timeout-remaining`, `session-cancel`, `session-resume`, `session-archive`, `session-logs` | Session detail (`/sessions/[id]`); running sessions expose accessible timeout progress and remaining time                 |
