...
| `sessions-table`, `session-row-*`, `session-status-*`, `session-status-reason-*`, `session-priority-*`, `session-created-*`, `session-duration-*`, `session-labels-*`                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | Sessions list rows, including status badges, terminal reason subtitles, persisted priority, accessible relative creation time, live/fixed duration, and required worktree labels                                                                                             |
