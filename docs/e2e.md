...
| `page-sessions`, `sessions-heading`, `session-filters`, `session-filter-status`, `session-filter-q`, `session-link-*`, `session-created-*`, `session-duration-*`                                                                                | Sessions list, including accessible relative creation time and live/fixed duration                                        |
