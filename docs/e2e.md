...
| `host-detail-overview`, `host-detail-status`, `host-detail-repo-count`, `host-detail-worktree-count`, `host-connected-at-*`, `host-restart-count-*`, `host-daemon-started-at-*`, `host-last-restart-*`                                                                                                                                                                                                                                                                                                                                                                                                                                   | Host detail's Overview tab — status, repository/worktree counts, connection time, and the daemon restart-observability block moved here from the fleet list                                                                                                                                                                      |
