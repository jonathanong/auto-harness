...
| `session-cancel`, `session-resume`, `session-archive`, `session-action-error`, `session-logs`, `session-logs-empty`, `session-detail-resolved-argv`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | Session actions + logs — `session-detail-resolved-argv` shows the resolved argv once assigned                                                                                                                                                    |
