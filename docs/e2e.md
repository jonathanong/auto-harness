...
| `sessions-table`, `session-row-*`, `session-priority-*`, `session-created-*`, `session-duration-*`, `session-labels-*`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | Sessions list rows, including persisted priority, accessible relative creation time, live/fixed duration, and required worktree labels                                                                                                                                       |
