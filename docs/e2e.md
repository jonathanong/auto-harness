...
| `worktree-detail-tabs`, `tab-sessions`, `tab-provider-accounts`, `tab-settings`, `worktree-detail-path`, `worktree-detail-online`, `edit-worktree-open`, `edit-worktree-dialog`, `form-edit-worktree`                                                                                                                                                                                                                                                                                                                                                                                                                                                            | Worktree detail tabs (Sessions default, Provider accounts, Settings); explicit Online/Offline connection badge; edit is a dialog                                                                                                                                                                                                        |
...
| `form-host-config-json`, `host-config-json`, `host-config-submit`, `host-config-ok`, `host-config-error`, `host-config-conflict`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Host detail's Advanced tab — raw JSON inventory editor (`HostConfigForm`, shared with the host pane's Settings page); `host-config-conflict` replaces the generic error when the save is rejected because the inventory changed since the tab loaded                                                                                    |
...
| `form-host-config-json`, `host-config-json`, `host-config-submit`, `host-config-ok`, `host-config-error`, `host-config-conflict`                                                                                                                                                                                                                                                                                                                                                                                        | Raw JSON inventory (on the Settings page, not Repositories); shared `HostConfigForm` component, also mounted on the control plane's Host detail Advanced tab                                                                                                                                    |
