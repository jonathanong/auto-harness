...
| `session-cancel`, `session-resume`, `session-archive`, `session-action-error`, `session-logs`, `session-logs-empty`, `session-logs-live-state`, `session-detail-resolved-argv`                                                                                                                                                                                                                                                                                                                                                                                                                                                           | Session actions + live logs — `session-logs-live-state` reports Live/Reconnecting/Paused/Unavailable; `session-detail-resolved-argv` shows the resolved argv once assigned                                                                       |
