...
| `session-cancel`, `session-resume`, `session-archive`, `session-action-error`, `session-logs`, `session-logs-empty`, `session-logs-live-tail`, `session-logs-live-state`, `session-logs-live-error`, `session-detail-resolved-argv`                                                                                                                                                                                                                                                                                                                                                                                                      | Session actions + logs — live tail connection/lifecycle/error state plus resolved argv once assigned                                                                                                                                                                         |
