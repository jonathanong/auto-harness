...
| `data-pw`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Where                                                                                                                                                                                                                                                                        |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `control-shell`, `keyboard-shortcuts-trigger`, `keyboard-shortcuts-dialog`, `keyboard-shortcut-new-session`, `keyboard-shortcut-help`, `keyboard-shortcut-go-*`, `keyboard-shortcut-close`, `shortcut-sequence-status`                                                                                                                                                                                                                                                                                                                                                                                                                   | App shell and global keyboard shortcut help/navigation                                                                                                                                                                                                                       |
...
| `form-create-session`, `create-session-repository-id`, `create-session-target`, `create-session-prompt`, `create-session-timeout`, `create-session-ref`, `create-session-priority`, `create-session-priority-value`, `create-session-labels`, `create-session-label-*`, `create-session-labels-empty`, `create-session-submit`, `create-session-error`                                                                                                                                                                                                                                                                                   | Create session form — `create-session-target` is a `SessionTargetSelect` sourced from `GET /api/v1/session-targets`; priority is 0–100; label chips are the unique labels advertised by online worktrees; ordered fallbacks and queue TTL controls are rendered alongside it |
| `sessions-table`, `session-row-*`, `session-status-*`, `session-status-reason-*`, `session-priority-*`, `session-sort-priority`, `session-created-*`, `session-duration-*`, `session-labels-*`                                                                                                                                                                                                                                                                                                                                                                                                                                           | Sessions list rows, including status badges, terminal reason subtitles, persisted priority with accessible server-backed sorting, accessible relative creation time, live/fixed duration, and required worktree labels                                                       |
| `page-session-detail`, `session-detail`, `session-detail-id`, `session-detail-copy-id`, `session-detail-copy-status`, `session-detail-status`, `session-detail-worktree`, `session-detail-timeout`, `session-timeout-progress`, `session-timeout-remaining`, `breadcrumbs`, `page-session-detail-not-found`                                                                                                                                                                                                                                                                                                                              | Session detail (`/sessions/[id]`), including accessible Session ID clipboard feedback, assigned worktree or scheduled main-checkout identity, and running timeout progress                                                                                                   |
| `session-cancel`, `session-resume`, `session-clone`, `session-clone-edit`, `session-archive`, `session-action-error`, `session-logs`, `session-logs-empty`, `session-logs-live-tail`, `session-logs-live-state`, `session-logs-live-error`, `session-detail-resolved-argv`                                                                                                                                                                                                                                                                                                                                                               | Session actions + logs — re-run, Clone & Edit, live tail connection/lifecycle/error state, and resolved argv once assigned                                                                                                                                                   |
...
| `page-repositories`, `repositories-heading`, `add-repo-open`, `worktrees-hierarchy`, `worktree-group-*`, `repo-link-*`, `worktree-row-*`, `worktree-link-*`, `worktree-online-*`                                                                                                                                                                                                                                                                                                                                                                                                                                                         | Repositories: repo → worktrees hierarchy (single merged section); worktree connection badges say Online/Offline                                                                                                                                                              |
...
| `page-hosts`, `hosts-heading`, `host-filters`, `host-filter-online`, `form-add-host`, `add-host-id`, `add-host-submit`, `add-host-ok`, `add-host-error`, `host-row-*`, `host-online-*`, `host-drain-*`                                                                                                                                                                                                                                                                                                                                                                                                                                   | Hosts; connection badges say Online/Offline                                                                                                                                                                                                                                  |
...
| `page-sessions`, `sessions-heading`, `session-filters`, `session-filter-status`, `session-filter-q`, `session-link-*`, `session-status-*`, `session-status-reason-*`, `session-created-*`, `session-duration-*`                                                            | Sessions list, including terminal status reasons, accessible relative creation time, and live/fixed duration                                                               |
| `page-session-detail`, `session-detail`, `session-detail-id`, `session-detail-status`, `session-detail-worktree`, `session-detail-timeout`, `session-timeout-progress`, `session-timeout-remaining`, `session-cancel`, `session-resume`, `session-archive`, `session-logs` | Session detail (`/sessions/[id]`), including assigned worktree or scheduled main-checkout identity; running sessions expose accessible timeout progress and remaining time |
