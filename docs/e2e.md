...
| `nav-dashboard`, `nav-session-new`, `nav-sessions`, `nav-schedules`, `nav-repositories`, `nav-providers`, `nav-commands`, `nav-worktrees`, `nav-hosts`, `nav-settings`                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | Nav — grouped as Operate/Catalog/Fleet/Settings, one horizontally-scrolling row; `app-title` links to `/`                                                                                                                                                                                                                        |
