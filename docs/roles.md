...
| `providers:leases`     | Inspect held Provider Account leases and force-release a lease only after its holder session is terminal. This is an operational recovery action, not Provider Account catalog configuration.                                                                                                         |
