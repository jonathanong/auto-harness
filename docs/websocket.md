...
| `host:registered`                    | `hostId`, `connectionId?`, `protocolVersion?`                                                                                                                                                                                                                                            | Durable acknowledgement that `host:register` was accepted. `protocolVersion` is the control plane's protocol (currently `4`); older daemons keep their negotiated behavior during rollout                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
Modern daemons advertise `protocolVersion` (currently `4`) and `runningAttempts: [{ sessionId, attemptId }]`.
Version `4` adds the durable pre-launch `session:command-start` handshake: the control plane records
