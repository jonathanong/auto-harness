...
| `session:status-acknowledged`        | `sessionId`, `attemptId`, optional `retryAccepted`, optional `terminalHookHandoffId`                                                                                                                                                                                                     | Durable application of a terminal report. For a v6 first-attempt `checkout_fetch_failed`, `retryAccepted: true` transfers terminal-hook ownership to the accepted retry. A terminal disposition carries the durable handoff id; the reporting daemon runs its retained hook, recollects the structured result, and completes that handoff before archival.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| `host:registered`                    | `hostId`, `connectionId?`, `protocolVersion?`                                                                                                                                                                                                                                            | Durable acknowledgement that `host:register` was accepted. `protocolVersion` is the control plane's protocol (currently `6`); older daemons keep their negotiated behavior during rollout                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
| `session:terminal-hook-complete` | `sessionId`, `handoffId`, optional `result`                                                                                                                                                                                                                                                                              | Durable confirmation after the daemon ran or safely no-oped a retained terminal hook. A v6 deferred-result handoff includes the bounded post-hook structured result.                                                                                                                                                                                                                                                                                                                                                                                                                             |
