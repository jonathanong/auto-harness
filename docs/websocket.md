...
| `session:log`                    | `sessionId`, `attemptId`, `stream`, `content`, `timestamp`, `seq`, optional `dropped`                                                                                                                                                                                                                                                     | In-memory/test path only. Durable transcript bodies are host `PUT` gzip parts, not WebSocket frames. `attemptId` is required.                                                                                                                                                                                                                                                                                                                                                                                        |
