...
the private S3 writer when `ARCHIVE_BUCKET` is configured. The bucket/lifecycle and scoped archive
policy synthesize locally; no account-backed upload or deployment has been run. Webhook
