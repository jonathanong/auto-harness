...
| 6   | Match storage to purpose                           | DynamoDB: compact coordination and archive pointers. S3: gzip transcript parts and history.        | Storing log bodies or frozen command snapshots on frequently updated lease records  |
