...
| Replay REST log history on the viewer socket                      | Viewer is tail-only                                                                                        | plan inv. 13, [logs.md](logs.md)                                        |
...
| Ignore protocol / capability gating                               | Mixed-version rollout: `scheduled-main-checkout`, `workspace-sessions`, v4 command-start, v6 deferred hook | [websocket.md](../websocket.md)                                         |
