...
| **Your VPS holds the tools and logins** | Subscription auth and git credentials stay on **your** machines. The control plane schedules and records; it does not become a second AI vendor account. See [security.md](security.md), [auth.md](auth.md).                                                                     |
