...
| Session resume pins placement          | Resume by session id → source host only; any eligible worktree re-checks out `ref`, skips setup, and runs native/frozen-command resume |
