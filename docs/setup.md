...
Copy-pasteable command, every OS. All platforms refuse `local-1`, local or malformed URLs, and an
empty or placeholder key before writing service files or restarting. Details and the Linux VPS
copy-unit path:
